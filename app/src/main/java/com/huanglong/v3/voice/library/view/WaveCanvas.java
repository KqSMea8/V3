package com.huanglong.v3.voice.library.view;
...
import com.huanglong.v3.voice.library.inter.CurrentPosInterface;
...
public class WaveCanvas {
    ...
    public void init() {
        ...
        markIcon = ((BitmapDrawable) mContext.getResources().getDrawable(R.mipmap.edit_mark)).getBitmap();
