...
import com.huanglong.v3.voice.library.utils.AudioUtils;
import com.huanglong.v3.voice.library.utils.CheapWAV;
...
import com.huanglong.v3.voice.library.view.WaveformView_1;
...
@ContentView(R.layout.activity_cut_record)
public class ListenCutActivity extends BaseActivity implements ScrollViewListener {
...
//    RelativeLayout mProjectTitle;
    ...
    private WaveformView_1 mWaveView;
    ...
    private void TimeSize() {
        ...
        mEndTime.setText(DateUtils.formatTime(mTotalTime));
    ...
    @Event(value = {R.id.title_back, R.id.save, R.id.recording, R.id.cut, R.id.delete_layout, R.id.waveview, R.id.title_tv_right})
