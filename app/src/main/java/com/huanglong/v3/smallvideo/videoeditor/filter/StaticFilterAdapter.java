package com.huanglong.v3.smallvideo.videoeditor.filter;
...
public class StaticFilterAdapter extends BaseRecyclerAdapter<StaticFilterAdapter.FilterViewHolder> {
    ...
    public FilterViewHolder onCreateVH(ViewGroup parent, int viewType) {
        return new FilterViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.video_filter_layout, parent, false));
    }
