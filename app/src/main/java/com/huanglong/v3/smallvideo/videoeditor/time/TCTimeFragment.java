package com.huanglong.v3.smallvideo.videoeditor.time;
...
import com.huanglong.v3.smallvideo.videoeditor.common.widget.videotimeline.SliderViewContainer;
...
public class TCTimeFragment extends BaseEditFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.time_tv_reverse:
                ...
                cancelSetEffect();
                showReverseLayout();
                ((TCVideoEffectActivity) getActivity()).stopPlay();
    ...
    private void cancelReverseEffect() {
        ...
        ((TCVideoEffectActivity) getActivity()).switchReverse();
        ((TCVideoEffectActivity) getActivity()).restartPlay();
    }
