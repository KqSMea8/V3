...
public class TCBGMManager {
    ...
    private SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(V3Application.getInstance());
...
//                    Type listType = new TypeToken<ArrayList<TCBGMInfo>>() {
//                    }.getType();
