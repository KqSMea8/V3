...
public class TCLoginMgr {
    ...
    public void guestLogin() {
        ...
        TCIMInitMgr.init(V3Application.getInstance().getApplicationContext());
    ...
    private String sig = "eJxNjVFPwjAURv9LXzFy21E2THyoBGINQhS2ASFpButmA6zd1iGL8b8754y*nnO*ez-Qara8jQ4HXWVW2NpIdIcA3bRYxTKzKlGyaCB2OhoZo2IRWeEU8b*4jI*iVd-tAACGMALcSXk1qpAiSuzPLUopaZLOXmRRKp01ggCmmDgAf9Kqs2wnBLvguNT7-afSBj9P-DF-vMiNxr0kNeuQn837dsmnp7lHzGzsndZ59TAgb0E*3coRZ2rCdv3VE3NNveunCy99PVbZfhgGPmNavoRBT81J6ecbw2u9X-j36PML-GZW*Q__";
     ...
     * imsdk登出
     */
    private void imLogout(TIMCallBack callBack) {
