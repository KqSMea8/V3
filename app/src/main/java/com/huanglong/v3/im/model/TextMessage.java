...
import com.huanglong.v3.im.utils.EmoticonUtil;
...
public class TextMessage extends Message implements Serializable {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        tv.setMaxWidth(PxUtil.dip2px(V3Application.getInstance(), 200));
    ...
    //
    public static SpannableStringBuilder getMsgStr(TIMMessage message, Context context) {
        boolean hasText = false;
        List<TIMElem> elems = new ArrayList<>();
        for (int i = 0; i < message.getElementCount(); ++i) {
            elems.add(message.getElement(i));
