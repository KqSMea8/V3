...
public class GroupMemberProfile implements ProfileSummary, Serializable {
     ...
     * @param callBack
     */
    public static void getMemberInfo(List<String> user, TIMValueCallBack<List<TIMUserProfile>> callBack) {
        TIMFriendshipManager.getInstance().getUsersProfile(user, callBack);
    }
