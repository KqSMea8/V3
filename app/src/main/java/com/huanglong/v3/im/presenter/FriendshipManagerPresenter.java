...
import com.huanglong.v3.im.viewfeatures.FriendInfoView;
...
public class FriendshipManagerPresenter {
    ...
    public void getFriendshipLastMessage() {
        ...
        long futureFlags = TIMFriendshipManager.TIM_FUTURE_FRIEND_DECIDE_TYPE
                | TIMFriendshipManager.TIM_FUTURE_FRIEND_PENDENCY_IN_TYPE
                | TIMFriendshipManager.TIM_FUTURE_FRIEND_PENDENCY_OUT_TYPE
                | TIMFriendshipManager.TIM_FUTURE_FRIEND_RECOMMEND_TYPE;
...
//        if (!isEnd) {
//            TIMFriendshipManager.getInstance().searchUserByNickname(key, index++, PAGE_SIZE, new TIMValueCallBack<TIMUserSearchSucc>() {
//
//                @Override
//                public void onError(int arg0, String arg1) {
//
...
//        TIMFriendshipManager.getInstance().modifyProfile(param, callBack);
     ...
     * @param callBack  回调
     */
    public static void setMySelfSignature(String signature, TIMCallBack callBack) {
        TIMFriendshipManager.getInstance().setSelfSignature(signature, callBack);
//        TIMFriendshipManager.ModifyUserProfileParam param = new TIMFriendshipManager.ModifyUserProfileParam();
...
//        TIMFriendshipManager.getInstance().modifyProfile(param, callBack);
     ...
     * @param callBack 回调
     */
    public static void setMyGender(TIMFriendGenderType sex, TIMCallBack callBack) {

        TIMFriendshipManager.getInstance().setGender(sex, callBack);
...
//        TIMFriendshipManager.getInstance().modifyProfile(param, callBack);
     ...
     * @param callBack 回调
     */
    public static void setMyUserHeadPic(String url, TIMCallBack callBack) {

        TIMFriendshipManager.getInstance().setFaceUrl(url, callBack);
...
//        TIMFriendshipManager.getInstance().modifyProfile(param, callBack);
    ...
    public static void setUserInfo(LoginBean loginBean, TIMCallBack callBack) {

        TIMFriendshipManager.getInstance().setFaceUrl(loginBean.getHead_image(), callBack);
        TIMFriendshipManager.getInstance().setNickName(loginBean.getUsername(), callBack);
//        TIMFriendshipManager.ModifyUserProfileParam param = new TIMFriendshipManager.ModifyUserProfileParam();
//        param.setFaceUrl(loginBean.getHead_image());
//        param.setNickname(loginBean.getUsername());
//        TIMFriendshipManager.getInstance().modifyProfile(param, callBack);
    }
     ...
     * @param callBack 回调
     */
    public static void setMyLocation(String location, TIMCallBack callBack) {

        TIMFriendshipManager.getInstance().setLocation(location, callBack);
//
//        TIMFriendshipManager.ModifyUserProfileParam param = new TIMFriendshipManager.ModifyUserProfileParam();
...
//        TIMFriendshipManagerExt.getInstance().modifySnsProfile(param, callBack);
     ...
     * @param callBack
     */
    public static void getFriendsProfile(List<String> identfiy, TIMValueCallBack<List<TIMUserProfile>> callBack) {
        TIMFriendshipManager.getInstance().getFriendsProfile(identfiy, callBack);
    }
     ...
     * @param callBack
     */
    public static void getOneFriendsProfile(String identfiy, TIMValueCallBack<List<TIMUserProfile>> callBack) {
        if (TextUtils.isEmpty(identfiy)) {
            return;
        }
        List<String> identfiys = new ArrayList<>();
        identfiys.add(identfiy);
        TIMFriendshipManager.getInstance().getFriendsProfile(identfiys, callBack);
        identfiys.clear();
        identfiys = null;
    }
     ...
     * @param callBack
     */
    public static void getOneUsersProfile(String identfiy, TIMValueCallBack<List<TIMUserProfile>> callBack) {
        if (TextUtils.isEmpty(identfiy)) {
            return;
        }
        List<String> identfiys = new ArrayList<>();
        identfiys.add(identfiy);
        TIMFriendshipManager.getInstance().getUsersProfile(identfiys, callBack);
        identfiys.clear();
        identfiys = null;
    }
     ...
     * 获取黑名单列表
     */
    public void getBlackList(TIMValueCallBack<List<String>> callBack) {
