...
//        context.startActivity(intent);
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()) {
            case INVITED_BY_OTHER:
                if (isSelf) {
                    return V3Application.getInstance().getResources().getString(R.string.summary_me) +
                            V3Application.getInstance().getResources().getString(R.string.summary_group_invite) +
                            to +
                            V3Application.getInstance().getResources().getString(R.string.summary_group_add);
                } else {
                    if (to.equals(UserInfo.getInstance().getId())) {
                        return from +
                                V3Application.getInstance().getResources().getString(R.string.summary_group_invite) +
                                V3Application.getInstance().getResources().getString(R.string.summary_me) +
                                V3Application.getInstance().getResources().getString(R.string.summary_group_add);
                    } else {
                        return from +
                                V3Application.getInstance().getResources().getString(R.string.summary_group_invite) +
            ...
            case APPLY_BY_SELF:
                if (isSelf) {
                    return V3Application.getInstance().getResources().getString(R.string.summary_me) +
                            V3Application.getInstance().getResources().getString(R.string.summary_group_apply) +
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                } else {
                    return from + V3Application.getInstance().getResources().getString(R.string.summary_group_apply) + GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return V3Application.getInstance().getString(R.string.conversation_system_group);
    }
