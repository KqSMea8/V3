...
public class MyCircleActivity extends BaseActivity implements XRecyclerView.LoadingListener, View.OnClickListener {

    @ViewInject(R.id.title_name)
    private TextView tv_title;
    @ViewInject(R.id.my_circle_list)
    private XRecyclerView circle_list;
    @ViewInject(R.id.my_circle_lin)
    ...
    public static MyCircleActivity instance;
