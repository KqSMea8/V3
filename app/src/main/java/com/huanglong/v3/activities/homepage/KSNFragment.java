...
public class KSNFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    private void requestKSongData() {
        RequestParams params = MRequestParams.getNoTokenParams(Api.music_location_list);
        params.addBodyParameter("user_id", UserInfoUtils.getUid());
        params.addBodyParameter("page", PAGE + "");
        params.addBodyParameter("longitude", KSongActivity.instance.str_longitude);
        params.addBodyParameter("latitude", KSongActivity.instance.str_latitude);
