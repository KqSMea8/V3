...
public class VFCFragment extends BaseFragment implements XRecyclerView.LoadingListener {

    @ViewInject(R.id.video_follow_list)
    ...
    public VFCFragment(String cid) {
        this.cid = cid;
    }

    @Override
    protected View getContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_video_follow_class, container, false);
        return view;
    }
...
//                intent.putExtra(TCConstants.TIMESTAMP, tcVideoInfo.createTime);
    ...
    private void requestVideoList() {
        RequestParams params = MRequestParams.getNoTokenParams(Api.video_follow_list);
