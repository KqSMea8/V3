...
public class ProgramFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    private List<ProgramBean> programAll = new ArrayList<>();

    private ImageView img_group_code;

    private QRCodeDialog qrCodeDialog;

    public ProgramFragment(String classId) {
    ...
    protected void initView() {
        ...
        talent_list.setAdapter(programAdapter);
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (!TextUtils.isEmpty(json)) {
                    ...
                    if (page == 1) {
                        programAll.clear();
                        programAll.addAll(programBean);
                    } else {
                        programAll.addAll(programBean);
                    }
                    programAdapter.setData(programAll);
                }
            }
