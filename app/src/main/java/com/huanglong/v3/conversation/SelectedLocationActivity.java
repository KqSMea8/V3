...
import com.huanglong.v3.adapter.SearchResultAdapter;
...
/**
 * Created by bin on 2017/10/16.
 * 选择地址
 */
@ContentView(R.layout.activity_selected_location_layout)
public class SelectedLocationActivity extends BaseActivity implements LocationSource,
    ...
    @ViewInject(R.id.loaction_listview)
    ...
    protected void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(SelectedLocationActivity.this);
...
//        });
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    InputtipsQuery inputquery = new InputtipsQuery(newText, str_location);
                    Inputtips inputTips = new Inputtips(SelectedLocationActivity.this, inputquery);
    ...
    private void mOnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.title_tv_right:
                ...
                intent.putExtra("poiItem", selPoiItem);
...
//        Log.i("MY", "onLocationChanged");
        if (mListener != null && amapLocation != null) {
            if (amapLocation != null
                ...
                searchText.setText("");
                str_location = amapLocation.getCity();
                tv_lacation.setText(str_location);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(SelectedLocationActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(SelectedLocationActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(SelectedLocationActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    private void updateListview(List<PoiItem> poiItems) {
        ...
        if (resultData.size() > 0) {
            PoiItem poiItem = resultData.get(0);
            selPoiItem = poiItem;
...
//                address = poiItem.getProvinceName()+poiItem.getCityName()+poiItem.get
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(SelectedLocationActivity.this, "erroCode " + rCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
