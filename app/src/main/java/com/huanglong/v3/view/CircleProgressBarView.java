...
public class CircleProgressBarView extends View {
    ...
    private void getArgus(AttributeSet attrs, Context context) {
        ...
        borderWidth = typedArray.getDimension(R.styleable.CircleProgressBarView_border_width, PxUtil.dip2px(context, 3));

        unReachedColor = typedArray.getColor(R.styleable.CircleProgressBarView_unreached_color, ContextCompat.getColor(context, R.color.gray_66));
        reachedColor = typedArray.getColor(R.styleable.CircleProgressBarView_reached_color, ContextCompat.getColor(context, R.color.colorAccent));
        numberColor = typedArray.getColor(R.styleable.CircleProgressBarView_number_color, ContextCompat.getColor(context, R.color.red_EF3338));
        numberSize = typedArray.getDimension(R.styleable.CircleProgressBarView_number_size, PxUtil.sp2px(context, 15));
        startNumScale = numberSize;
        endNumScale = PxUtil.sp2px(context, PxUtil.px2sp(context, startNumScale) + 2);
        ...
        endNumColor = ContextCompat.getColor(context, R.color.red_EF3338);
        arcRect = new RectF();

        startColorFulColor = reachedColor;
        endColorFulColor = ContextCompat.getColor(context, R.color.gray_66);
