package com.huanglong.v3.live.utils;
...
public class TCConstants {
    ...
    //云通信服务相关配置
    public static final int IMSDK_ACCOUNT_TYPE = 792;
    public static final int IMSDK_APPID = 1400060901;
    ...
    //小直播appid
    public static final int XIAOZHIBO_APPID = 10122927;
    ...
    public static final String PUSHER_FOLLOW = "pusher_follow";
    ...
    public static final int TYPE_EDITER_SHEAR = 7;
    ...
    public static final int LIVE_GIFT = 6;    //直播礼物


    public static final String ZAN = "zan";   // 赞
    public static final String CANCEL_ZAN = "cancel_zan";//取消赞
    ...
    public static final String BGM_DURATION = "bgm_duration";
