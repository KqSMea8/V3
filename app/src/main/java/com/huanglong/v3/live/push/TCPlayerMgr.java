...
public class TCPlayerMgr {
     ...
     */
    public void enterGroup(String userId, String liveUserId, String groupId, String nickname, String headPic, int flag) {
        if (mPlayerListener != null) {
...
//        }
    ...
    public void fetchGroupMembersList(String liveUserId, String groupId, int pageNo, int pageSize, final OnGetMembersListener listener) {
        ...
        RequestParams params = MRequestParams.getNoTokenParams(Api.live_avatar_list);
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (!TextUtils.isEmpty(json)) {
                    ...
                    List<TCSimpleUserInfo> infos = gson.fromJson(json, new TypeToken<LinkedList<TCSimpleUserInfo>>() {
                    }.getType());
                    if (infos != null) {
                        if (listener != null) {
                            listener.onGetMembersList(0, infos.size(), infos);
                        }
                    }
                }
            }
...
//                            Type listType = new TypeToken<List<TCSimpleUserInfo>>() {
//                            }.getType();
