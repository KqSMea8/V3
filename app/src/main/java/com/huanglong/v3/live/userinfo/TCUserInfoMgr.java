package com.huanglong.v3.live.userinfo;
...
//        });
    ...
    public void setUserSign(final String sign, final ITCUserInfoMgrListener listener) {
        ...
        FriendshipManagerPresenter.setMySelfSignature(sign, new TIMCallBack() {
            @Override
            public void onError(int i, String s) {
...
//        TIMFriendshipManager.getInstance().setSelfSignature(sign, );
    }
    ...
    public void setUserSex(final TIMFriendGenderType sex, final ITCUserInfoMgrListener listener) {
        ...
        FriendshipManagerPresenter.setMyGender(sex, new TIMCallBack() {
            @Override
            public void onError(int i, String s) {
...
//        TIMFriendshipManager.getInstance().setGender(sex, );
    ...
    public void setUserHeadPic(final String url, final ITCUserInfoMgrListener listener) {
        ...
        FriendshipManagerPresenter.setMyUserHeadPic(url, new TIMCallBack() {
            @Override
            public void onError(int i, String s) {
...
//        TIMFriendshipManager.getInstance().setFaceUrl(url, );
    }
    ...
    public void setUserCoverPic(final String url, final ITCUserInfoMgrListener listener) {
        ...
        FriendshipManagerPresenter.setMySelfSignature(url, new TIMCallBack() {
            @Override
            public void onError(int i, String s) {
    ...
    public void setLocation(@NonNull final String location, final double latitude, final double longitude, final ITCUserInfoMgrListener listener) {
        ...
        FriendshipManagerPresenter.setMyLocation(location, new TIMCallBack() {
            @Override
            public void onError(int i, String s) {
